...
public class AdvancedSearchActivity {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);     
        WebElement spendType = dr.findElementById("cntMain_ddlSpendType_chosen");
        spendType.click();
        Thread.sleep(2000);
        WebElement spendTypeOption = dr.findElementByXPath("//*[@id='cntMain_ddlSpendType_chosen']/div/ul/li[7]");
        spendTypeOption.click();
        Thread.sleep(2000);
        WebElement products = dr.findElementById("ddlproducts_chosen");
        products.click();
